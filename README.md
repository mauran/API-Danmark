...
| [Relatel](https://dev.relatel.dk/)                                                |   JSON   |    Private     |
...
| API                                                                                                                                 |           Type           | Tilgængelighed |
|-------------------------------------------------------------------------------------------------------------------------------------|:------------------------:|:--------------:|
| [Circle K/Ingo]([https://api.circlek.com/eu/prices](https://www.circlek.dk/media-assets/uploads/2025-12/DK%20Fuel%20Prices%20API%20doc.pdf))                                                                                  |           JSON           |     Public     |
